...
public:
    Signal_Cal() = default;
    std::vector<Struct_Planner::Coordinate> calculate_signal(const Struct_Planner::Config_struct &global_config,const std::vector<Struct_Planner::SignalServerConfig> &signal_server_confs) const;
